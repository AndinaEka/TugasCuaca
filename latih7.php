<html>
	<head>
		...
		<style type="text/css">
			...
			body {
				color: #666666;
				background-color: url("images/pink2.jpg");
...
<?php
  ...
  $temperatur = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'high'}->{'celsius'};
  $temperatur1 = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'low'}->{'celsius'};
  $wind_mph= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'avewind'}->{'mph'};
  $wind_dir= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'avewind'}->{'dir'};
  $weekday= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'date'}->{'weekday'};
  $day= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'date'}->{'day'};
  $month= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'date'}->{'monthname'};
  $year= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'date'}->{'year'};
  $weather= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[6]->{'conditions'};
