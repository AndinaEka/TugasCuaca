...
<?php
  ...
  $temperatur = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'high'}->{'celsius'};
  $temperatur1 = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'low'}->{'celsius'};
  $wind_mph= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'avewind'}->{'mph'};
  $wind_dir= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'avewind'}->{'dir'};
  $weekday= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'date'}->{'weekday'};
  $day= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'date'}->{'day'};
  $month= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'date'}->{'monthname'};
  $year= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'date'}->{'year'};
  $weather= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[3]->{'conditions'};
