...
<?php
  ...
  $temperatur = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'high'}->{'celsius'};
  $temperatur1 = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'low'}->{'celsius'};
  $wind_mph= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'avewind'}->{'mph'};
  $wind_dir= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'avewind'}->{'dir'};
  $weekday= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'date'}->{'weekday'};
  $day= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'date'}->{'day'};
  $month= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'date'}->{'monthname'};
  $year= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'date'}->{'year'};
  $weather= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[4]->{'conditions'};
