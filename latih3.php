...
<?php
  ...
  $temperatur = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'high'}->{'celsius'};
  $temperatur1 = $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'low'}->{'celsius'};
  $wind_mph= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'avewind'}->{'mph'};
  $wind_dir= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'avewind'}->{'dir'};
  $weekday= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'date'}->{'weekday'};
  $day= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'date'}->{'day'};
  $month= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'date'}->{'monthname'};
  $year= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'date'}->{'year'};
  $weather= $parsed_json1->{'forecast'}->{'simpleforecast'}->forecastday[2]->{'conditions'};
